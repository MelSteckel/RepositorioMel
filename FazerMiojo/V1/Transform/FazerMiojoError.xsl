  ...
  <oracle-xsl-mapper:schema>
    ...
    <oracle-xsl-mapper:mapTargets>
      <oracle-xsl-mapper:target type="XSD">
        <oracle-xsl-mapper:schema location="../XSD/FazerMiojo.Operacao.Erro.xsd"/>
        <oracle-xsl-mapper:rootElement name="ResponseERROR" namespace="http://www.ibm.com/FazerMiojoResponse/XSD"/>
      </oracle-xsl-mapper:target>
    </oracle-xsl-mapper:mapTargets>
    <!--GENERATED BY ORACLE XSL MAPPER 12.1.3.0.0(XSLT Build 140529.0700.0211) AT [THU JUL 23 20:33:42 BRT 2020].-->
  </oracle-xsl-mapper:schema>
  <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
  <xsl:template match="/">
    <tns:ResponseERROR>
      <tns:RelatorioErro>
        <tns:MensagemErro>"O tempo das ampulhetas deve ser maior que o de cozimento! Tente novamente!"</tns:MensagemErro>
      </tns:RelatorioErro>
    </tns:ResponseERROR>
  </xsl:template>
</xsl:stylesheet>
